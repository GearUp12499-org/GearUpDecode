...
class PoseSet private constructor(val invert: Boolean) {
    ...
    companion object {
        ...
        private val set1out = RobotPose(12.0, -56.625, -Math.PI / 2)
        private val set2pos = RobotPose(-12.0, -30.375, -Math.PI / 2)
        private val set2out = RobotPose(-12.0, -64.125, -Math.PI / 2)
        private val set3pos = RobotPose(-36.0, -30.375, -Math.PI / 2)
        private val set3out = RobotPose(-36.0,  -64.125, -Math.PI / 2)
