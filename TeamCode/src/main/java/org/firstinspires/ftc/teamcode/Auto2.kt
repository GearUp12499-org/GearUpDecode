...
import org.firstinspires.ftc.teamcode.hardware.CompBotHardware.SHOOT_FARRANGE
...
import org.firstinspires.ftc.teamcode.hardware.CompBotHardware.redFarShoot
...
class Auto2 : LinearOpMode() {
    ...
    override fun runOpMode() {
        ...
        startFlag.then(shooter.setTargetAndWait(SHOOT_FARRANGE))

        knowObelisk
            .then(VirtualGroup {
                add(REmover.drive2Pose(hardware, redFarShoot))
                val idxMove = add(
